var app = {
    ...
    $('[data-scrollview="true"]').each(function () {
      ...
      scrollMonitor.create(e, 60).enterViewport(function () {
        $(e)
          ...
          .each(function () {
            var e,
              t = $(this).attr("data-animation-type"),
              a = $(this);
            $(a).hasClass("contentAnimated") ||
              ("number" == t
                ? ((e = parseInt($(a).attr("data-final-number"))),
  ...
  handleHeaderScrollToAction = function () {
    $(document).on("click", "[data-click=scroll-to-target]", function (e) {
      ...
      var e =
          !(e = $(this).attr("data-scroll-target")
            ? $(this).attr("data-scroll-target")
            : "") && $(this).attr("href")
            ? $(this).attr("href")
            : e,
        t = $(this).closest(".header").length,
        e =
  ...
  handleThemePanel = function () {
        ...
        (e &&
          (e.onclick = function (e) {
            ...
            var e = document.querySelector("." + app.themePanel.class),
              t = !e.classList.contains(app.themePanel.activeClass);
            e.classList.toggle(app.themePanel.activeClass),
    ...
    t &&
      t.map(function (o) {
        o.onclick = function () {
          for (
            var e = this.getAttribute(app.themePanel.theme.classAttr), t = 0;
            t < document.body.classList.length;
            t++
          ) {
            var a = document.body.classList[t];
            -1 < a.search("theme-") && document.body.classList.remove(a);
          }
